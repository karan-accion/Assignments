...
class NumberGuessingGame {
    public static void main(String[] args) {
        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            while (playAgain) {
                int max = 100; // default range 0..max-1
                try {
                    ...
                    if (!line.isEmpty()) {
                        try {
                            ...
                            if (parsed > 1) max = parsed;
                        } catch (NumberFormatException nfe) {
                            System.out.println("Invalid range input; using default 100.");
                        }
                    }
                } catch (Exception ex) {
                    System.out.println("Using default range 100.");
                }
